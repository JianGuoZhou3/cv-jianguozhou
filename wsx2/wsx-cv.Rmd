...
<h3>Journal articles <span class="review-note">(fully reviewed, † for co-first)</span></h3>
...
publications_formatted |>
  ...
  mutate(venue = if_else(mark == "y", glue("{venue} <b>(representative work)</b>"), venue, venue)) |> 
...
p <- ggplot(citation, aes(cites, year)) +
  ...
  labs(caption = "data from Google Scholar (https://scholar.google.com/citations?user=FvNp0NkAAAAJ)") +
